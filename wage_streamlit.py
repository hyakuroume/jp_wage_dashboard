...
df_jp_lat_lon = pd.read_csv('./pref_lat_lon.csv')
df_jp_lat_lon = df_jp_lat_lon.rename(columns={'pref_name' : '都道府県名'})


df_pref_map = df_pref_ind[(df_pref_ind['年齢'] == '年齢計') & (df_pref_ind['集計年'] == 2019)]
df_pref_map = pd.merge(df_pref_map, df_jp_lat_lon, on='都道府県名')
